...
description: 12 behavioral guidelines to reduce common LLM coding mistakes. Use when writing, reviewing, or refactoring code to surface assumptions, avoid overcomplication, make surgical changes, define verifiable success criteria, stay honest, plan before coding, and pick the right model.
license: MIT
---
